...
class ResNet18_Encoder(nn.Module):
    def __init__(self, output_dimension):
        ...
        self.resnet.fc = nn.Linear(in_features=512, out_features=output_dimension, bias=True)
...
class ConvNet_Encoder(nn.Module):
    def __init__(self, output_dimension):
        ...
        self.convnet.features[0][0] = nn.Conv2d(1, 96, kernel_size=(4, 4), stride=(4, 4))
        self.convnet.classifier[2] = nn.Linear(in_features=768, out_features=output_dimension, bias=True)
...
class RegNetX_Encoder(nn.Module):
    def __init__(self, output_dimension):
        ...
        self.regnetx.stem[0] = nn.Conv2d(1, 32, kernel_size=(3, 3), stride=(2, 2), padding=(1, 1), bias=False)
        self.regnetx.fc = nn.Linear(in_features=1008, out_features=output_dimension, bias=True)
...
class EfficientNet_Encoder(nn.Module):
    def __init__(self, output_dimension):
        ...
        self.efficient_net[0][0] = nn.Conv2d(1, 32, kernel_size=(3, 3), stride=(2, 2), padding=(1, 1), bias=False)
...
class SwinTransformerS_Encoder(nn.Module):
    def __init__(self, output_dimension):
        ...
        self.swin_transformer.features[0][0] = nn.Conv2d(1, 96, kernel_size=(4, 4), stride=(4, 4))
        self.swin_transformer.head = nn.Linear(in_features=768, out_features=output_dimension, bias=True)
...
class WideResnet50_Encoder(nn.Module):
    def __init__(self, output_dimension):
        ...
        self.wideresnet.conv1 = nn.Conv2d(1, 64, kernel_size=(7, 7), stride=(2, 2), padding=(3, 3), bias=False)
        self.linear = nn.Linear(1000, output_dimension)
...
class RegNetY_Encoder(nn.Module):
    def __init__(self, output_dimension):
        ...
        self.regnety.stem[0] = nn.Conv2d(1, 32, kernel_size=(3, 3), stride=(2, 2), padding=(1, 1), bias=False)
        self.regnety.fc = nn.Linear(in_features=784, out_features=output_dimension, bias=True)
...
class ShuffleNet_Encoder(nn.Module):
    def __init__(self, output_dimension):
        ...
        self.shuffle_net.conv1[0] = nn.Conv2d(1, 24, kernel_size=(3, 3), stride=(2, 2), padding=(1, 1), bias=False)
        self.shuffle_net.fc = nn.Linear(in_features=1024, out_features=output_dimension, bias=True)
